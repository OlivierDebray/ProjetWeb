    ...
    paypal.Button.render({
      ...
      payment: function() {
        ...
        return paypal.request.post(CREATE_URL)
          .then(function(data) { 
          console.log(data);// Notre script PHP renvoie un certain nombre d'informations en JSON (vous savez, grâce à notre echo json_encode(...) dans notre script PHP !) qui seront récupérées ici dans la variable "data"
      ...
      onAuthorize: function(data, actions) {
        ...
        return paypal.request.post(EXECUTE_URL, data)
          .then(function (data) {
            console.log(data); // Notre script renverra une réponse (du JSON), à nouveau stockée dans le paramètre "data"
